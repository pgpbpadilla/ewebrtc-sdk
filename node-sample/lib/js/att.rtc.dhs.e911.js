...
/*global require, exports, restify*/
...
(function () {
  ...
  function createE911Id(options) {
    if (undefined === exports.e911.app_key
        || undefined === exports.e911.app_secret) {
    ...
    if (undefined === options.token) {
      throw new Error('No E911 token provided');
    }
    ...
    if (undefined === options.is_confirmed) {
      throw new Error('No is address confirmed provided');
    }
